from independent_shopping import Person
from store_shopping import Store


def main():
    person1 = Person("Miriam", "Ezrat Torah 37", "voucher")
    print(person1.get_last_name())
    print(person1.get_address())
    print(person1.pref_transport_method())
    
    store1 = Store("Geula" , "Kikar Shabbos Savings", True)
    print(store1.get_store_address())
    print(store1.get_store_name())
    print(store1.get_if_store_well_stocked())
